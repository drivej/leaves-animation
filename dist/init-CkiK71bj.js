import { E as p, U as ht, T as de, G as Re, a as Ue, M as P, n as G, i as Be, I as w, v as R, a6 as re, R as ne, w as q, H as Me, a3 as I, a4 as Ge, h as A, B as C, D as L, ad as he, Q, ae as M, o as E, af as ft, $ as De, ag as fe, c as B, z as V, ah as pt, ai as ie, L as J, aj as k, S as se, _ as Z, p as Ae, t as ze, a8 as ke, ab as Oe, q as mt, s as gt, a9 as xt, aa as _t, ac as bt, ak as vt, al as yt, am as ee, an as Tt, ao as wt, ap as pe, e as y, aq as Ct } from "./index-4MFd23lX.js";
import { F as Pt, S as W, c as Y, a as St, b as Ft, B as Ie } from "./colorToUniform-Cm8VEX8y.js";
class Ee {
  /**
...
function Mt(o, e) {
  ...
  for (let r = 0; r < o.length; r++) {
    ...
    if (n.globalDisplayStatus < 7)
      continue;
    const i = n.renderGroup ?? n.parentRenderGroup;
    i?.isCachedAsTexture ? e.matrix = ge.copyFrom(i.textureOffsetInverseTransform).append(n.worldTransform) : i?._parentCacheAsTextureRenderGroup ? e.matrix = ge.copyFrom(i._parentCacheAsTextureRenderGroup.inverseWorldTransform).append(n.groupTransform) : e.matrix = n.worldTransform, e.addBounds(n.bounds);
  }
  return e.matrix = t, e;
}
const Gt = new re({
...
class Le {
  constructor(e) {
    this._filterStackIndex = 0, this._filterStack = [], this._filterGlobalUniforms = new G({
  ...
  push(e) {
    ...
    const i = t.renderTarget.renderTarget.colorTexture.source, s = i.resolution, a = i.antialias;
    if (r.every((f) => !f.enabled)) {
      n.skip = !0;
      return;
    }
    const l = n.bounds;
    if (this._calculateFilterArea(e, l), this._calculateFilterBounds(n, t.renderTarget.rootViewPort, a, s, 1), n.skip)
      return;
    const u = this._getPreviousFilterData(), h = this._findFilterResolution(s);
    let c = 0, d = 0;
  ...
  generateFilteredTexture({ texture: e, filters: t }) {
    ...
    const n = e.source, i = n.resolution, s = n.antialias;
    if (t.every((f) => !f.enabled))
      return r.skip = !0, e;
    const a = r.bounds;
    if (a.addRect(e.frame), this._calculateFilterBounds(r, a.rectangle, s, i, 0), r.skip)
      return e;
    const l = i;
  ...
  getBackTexture(e, t, r) {
    const n = e.colorTexture.source._resolution, i = w.getOptimalTexture(
      t.width,
      t.height,
      n,
      !1
    ...
    r && (s -= r.minX, a -= r.minY), s = Math.floor(s * n), a = Math.floor(a * n);
   ...
   */
  applyFilter(e, t, r, n) {
    const i = this.renderer, s = this._activeFilterData, l = s.outputRenderSurface === r, u = i.renderTarget.rootRenderTarget.colorTexture.source._resolution, h = this._findFilterResolution(u);
    let c = 0, d = 0;
    if (l) {
      const m = this._findPreviousFilterOffset();
      c = m.x, d = m.y;
    }
    this._updateFilterUniforms(t, r, s, c, d, h, l, n);
    const f = e.enabled ? e : this._getPassthroughFilter();
    this._setupBindGroupsAndRender(f, t, i);
  }
  /**
  ...
  calculateSpriteMatrix(e, t) {
    const r = this._activeFilterData, n = e.set(
      ...
      r.bounds.minX,
      r.bounds.minY
    ), i = t.worldTransform.copyTo(P.shared), s = t.renderGroup || t.parentRenderGroup;
    return s && s.cacheToLocalTransform && i.prepend(s.cacheToLocalTransform), i.invert(), n.prepend(i), n.scale(
  ...
  _getPassthroughFilter() {
    return this._passthroughFilter ?? (this._passthroughFilter = new Bt()), this._passthroughFilter;
  }
  /**
   ...
   */
  _calculateGlobalFrame(e, t, r, n, i, s) {
    const a = e.globalFrame;
    a.x = t * n, a.y = r * n, a.width = i * n, a.height = s * n;
  }
  /**
   ...
   */
  _updateFilterUniforms(e, t, r, n, i, s, a, l) {
    ...
    a ? (h[0] = r.bounds.minX - n, h[1] = r.bounds.minY - i) : (h[0] = 0, h[1] = 0), h[2] = e.frame.width, h[3] = e.frame.height, c[0] = e.source.width, c[1] = e.source.height, c[2] = 1 / c[0], c[3] = 1 / c[1], d[0] = e.source.pixelWidth, d[1] = e.source.pixelHeight, d[2] = 1 / d[0], d[3] = 1 / d[1], f[0] = 0.5 * d[2], f[1] = 0.5 * d[3], f[2] = e.frame.width * c[2] - 0.5 * d[2], f[3] = e.frame.height * c[3] - 0.5 * d[3];
    const g = this.renderer.renderTarget.rootRenderTarget.colorTexture;
    m[0] = n * s, m[1] = i * s, m[2] = g.source.width * s, m[3] = g.source.height * s, t instanceof R && (t.source.resource = null);
  ...
  _calculateFilterArea(e, t) {
    if (e.renderables ? Mt(e.renderables, t) : e.filterEffect.filterArea ? (t.clear(), t.addRect(e.filterEffect.filterArea), t.applyMatrix(e.container.worldTransform)) : e.container.getFastGlobalBounds(!0, t), e.container) {
      const n = (e.container.renderGroup || e.container.parentRenderGroup).cacheToLocalTransform;
      n && t.applyMatrix(n);
    }
  }
  _applyFiltersToTexture(e, t) {
    const r = e.inputTexture, n = e.bounds, i = e.filters, s = e.firstEnabledIndex, a = e.lastEnabledIndex;
    if (this._globalFilterBindGroup.setResource(r.source.style, 2), this._globalFilterBindGroup.setResource(e.backTexture.source, 3), s === a)
      i[s].apply(this, r, e.outputRenderSurface, t);
    else {
      ...
      i[a].apply(this, l, e.outputRenderSurface, t), w.returnTexture(u);
    }
  }
  _calculateFilterBounds(e, t, r, n, i) {
    ...
    for (let _ = 0; _ < l.length; _++) {
      ...
      if (!b.enabled)
        continue;
      if (x === -1 && (x = _), g = _, u = Math.min(u, b.resolution === "inherit" ? n : b.resolution), h += b.padding, b.antialias === "off" ? c = !1 : b.antialias === "inherit" && c && (c = r), b.clipToViewport || (m = !1), !!!(b.compatibleRenderers & s.type)) {
        f = !1;
        break;
      }
      if (b.blendRequired && !(s.backBuffer?.useBackBuffer ?? !0)) {
        q("Blend filter requires backBuffer on WebGL renderer to be enabled. Set `useBackBuffer: true` in the renderer options."), f = !1;
        break;
      }
    ...
    if (m && a.fitBounds(0, t.width / n, 0, t.height / n), a.scale(u).ceil().scale(1 / u).pad((h | 0) * i), !a.isPositive) {
      e.skip = !0;
      return;
    }
  ...
  _pushFilterData() {
    ...
    return e || (e = this._filterStack[this._filterStackIndex] = new Dt()), this._filterStackIndex++, e;
  }
}
Le.extension = {
  type: [
...
const Ye = class He extends re {
  constructor(...e) {
    let t = e[0] ?? {};
    t instanceof Float32Array && (I(Ge, "use new MeshGeometry({ positions, uvs, indices }) instead"), t = {
      positions: t,
      uvs: e[1],
      indices: e[2]
    ...
    const i = t.indices || new Uint32Array([0, 1, 2, 0, 2, 3]), s = t.shrinkBuffersToFit, a = new A({
      data: r,
...
let ae = Ye, U = null, S = null;
function At(o, e) {
  U || (U = L.get().createCanvas(256, 128), S = U.getContext("2d", { willReadFrequently: !0 }), S.globalCompositeOperation = "copy", S.globalAlpha = 1), (U.width < o || U.height < e) && (U.width = he(o), U.height = he(e));
}
function xe(o, e, t) {
...
function _e(o, e, t, r, n) {
  const i = 4 * e;
  for (let s = r, a = r * i + 4 * t; s <= n; ++s, a += i)
    if (o[a + 3] !== 0)
      return !1;
  return !0;
}
function zt(...o) {
  ...
  const { canvas: t } = e, r = Math.min(e.resolution ?? 1, 1), n = e.width ?? t.width, i = e.height ?? t.height;
  let s = e.output;
  if (At(n, i), !S)
  ...
  for (; _e(l, n, c, h, d); )
    --c;
  return ++c, ++d, S.globalCompositeOperation = "source-over", S.strokeRect(u, h, c - u, d - h), S.globalCompositeOperation = "copy", s ?? (s = new Q()), s.set(u / r, h / r, (c - u) / r, (d - h) / r), s;
}
const be = new Q();
class kt {
  /**
  ...
  getCanvasAndContext(e) {
    const { text: t, style: r, resolution: n = 1 } = e, i = r._getFinalPadding(), s = M.measureText(t || " ", r), a = Math.ceil(Math.ceil(Math.max(1, s.width) + i * 2) * n), l = Math.ceil(Math.ceil(Math.max(1, s.height) + i * 2) * n), u = E.getOptimalCanvasAndContext(a, l);
    this._renderTextToCanvas(t, r, i, n, u);
    const h = r.trim ? zt({ canvas: u.canvas, width: a, height: l, resolution: 1, output: be }) : be.set(0, 0, a, l);
    return {
      canvasAndContext: u,
      frame: h
    };
   ...
   */
  _renderTextToCanvas(e, t, r, n, i) {
    const { canvas: s, context: a } = i, l = ft(t), u = M.measureText(e || " ", t), h = u.lines, c = u.lineHeight, d = u.lineWidths, f = u.maxLineWidth, m = u.fontProperties, x = s.height;
    ...
    for (let T = 0; T < b; ++T) {
      const z = t.dropShadow && T === 0, F = z ? Math.ceil(Math.max(1, x) + r * 2) : 0, D = F * n;
      if (z) {
        a.fillStyle = "black", a.strokeStyle = "black";
        const v = t.dropShadow, lt = v.color, ct = v.alpha;
        a.shadowColor = De.shared.setValue(lt).setAlpha(ct).toRgbaString();
        const dt = v.blur * n, ce = v.distance * n;
        a.shadowBlur = dt, a.shadowOffsetX = Math.cos(v.angle) * ce, a.shadowOffsetY = Math.sin(v.angle) * ce + D;
      } else {
        if (a.fillStyle = t._fill ? fe(t._fill, a, u, r * 2) : null, t._stroke?.width) {
          const v = t._stroke.width * 0.5 + r * 2;
          a.strokeStyle = fe(t._stroke, a, u, v);
        }
        a.shadowColor = "black";
      }
      let ue = (c - m.fontSize) / 2;
      c - m.fontSize < 0 && (ue = 0);
      const le = t._stroke?.width ?? 0;
      for (let v = 0; v < h.length; v++)
        g = le / 2, _ = le / 2 + v * c + m.ascent + ue, t.align === "right" ? g += f - d[v] : t.align === "center" && (g += (f - d[v]) / 2), t._stroke?.width && this._drawLetterSpacing(
          h[v],
          t,
          i,
          g + r,
   ...
   * @private
   */
  _drawLetterSpacing(e, t, r, n, i, s = !1) {
    const { context: a } = r, l = t.letterSpacing;
    let u = !1;
    if (M.experimentalLetterSpacingSupported && (M.experimentalLetterSpacing ? (a.letterSpacing = `${l}px`, a.textLetterSpacing = `${l}px`, u = !0) : (a.letterSpacing = "0px", a.textLetterSpacing = "0px")), l === 0 || u) {
      s ? a.strokeText(e, n, i) : a.fillText(e, n, i);
      return;
    }
    let h = n;
    const c = M.graphemeSegmenter(e);
    let d = a.measureText(e).width, f = 0;
    for (let m = 0; m < c.length; ++m) {
      const x = c[m];
      s ? a.strokeText(x, h, i) : a.fillText(x, h, i);
      let g = "";
...
const H = new kt(), ve = "http://www.w3.org/2000/svg", ye = "http://www.w3.org/1999/xhtml";
class Xe {
  constructor() {
    this.svgRoot = document.createElementNS(ve, "svg"), this.foreignObject = document.createElementNS(ve, "foreignObject"), this.domElement = document.createElementNS(ye, "div"), this.styleElement = document.createElementNS(ye, "style");
    const { foreignObject: e, svgRoot: t, styleElement: r, domElement: n } = this;
    e.setAttribute("width", "10000"), e.setAttribute("height", "10000"), e.style.overflow = "hidden", t.appendChild(e), e.appendChild(r), e.appendChild(n), this.image = L.get().createImage();
  }
  destroy() {
...
function Ot(o, e, t, r) {
  r || (r = Te || (Te = new Xe()));
  const { domElement: n, styleElement: i, svgRoot: s } = r;
  n.innerHTML = `<style>${e.cssStyle};</style><div style='padding:0'>${o}</div>`, n.setAttribute("style", "transform-origin: top left; display: inline-block"), t && (i.textContent = t), document.body.appendChild(s);
...
class Ke {
  constructor(e, t) {
    this.state = W.for2d(), this.renderer = e, this._adaptor = t, this.renderer.runners.contextChange.add(this), this._managedGraphics = new B({ renderer: e, type: "renderable", priority: -1, name: "graphics" });
  }
  contextChange() {
  ...
  execute(e) {
    ...
    s.uTransformMatrix = e.groupTransform, s.uRound = t._roundPixels | e._roundPixels, Y(
      e.groupColorAlpha,
      s.uColor,
      0
  ...
  _updateBatchesForRenderable(e, t) {
    const r = e.context, n = this.renderer.graphicsContext.getGpuContext(r), i = this.renderer._roundPixels | e._roundPixels;
    t.batches = n.batches.map((s) => {
      const a = V.get(pt);
      return s.copyTo(a), a.renderable = e, a.roundPixels = i, a;
    });
  }
  destroy() {
...
const $e = class je extends ae {
  constructor(...e) {
    super({});
    let t = e[0] ?? {};
    typeof t == "number" && (I(Ge, "PlaneGeometry constructor changed please use { width, height, verticesX, verticesY } instead"), t = {
      width: t,
      height: e[1],
      verticesX: e[2],
      verticesY: e[3]
  ...
  build(e) {
    ...
    const t = this.verticesX * this.verticesY, r = [], n = [], i = [], s = this.verticesX - 1, a = this.verticesY - 1, l = this.width / s, u = this.height / a;
    for (let c = 0; c < t; c++) {
      const d = c % this.verticesX, f = c / this.verticesX | 0;
      r.push(d * l, f * u), n.push(d / s, f / a);
    }
    const h = s * a;
    for (let c = 0; c < h; c++) {
      const d = c % s, f = c / s | 0, m = f * this.verticesX + d, x = f * this.verticesX + d + 1, g = (f + 1) * this.verticesX + d, _ = (f + 1) * this.verticesX + d + 1;
      i.push(
        m,
        x,
        g,
    ...
    this.buffers[0].data = new Float32Array(r), this.buffers[1].data = new Float32Array(n), this.indexBuffer.data = new Uint32Array(i), this.buffers[0].update(), this.buffers[1].update(), this.indexBuffer.update();
  }
};
$e.defaultOptions = {
  width: 100,
...
class oe {
  ...
  get uvs() {
    ...
    return i.isSimple || (n = this._transformedUvs, (this._textureMatrixUpdateId !== i._updateID || this._uvUpdateId !== t._updateID) && ((!n || n.length < r.length) && (n = this._transformedUvs = new Float32Array(r.length)), this._textureMatrixUpdateId = i._updateID, this._uvUpdateId = t._updateID, i.multiplyUvs(r, n))), n;
  }
  get positions() {
...
class Ne {
  ...
  execute(e) {
    if (!e.isRenderable)
      return;
    e.state.blendMode = ie(e.groupBlendMode, e.texture._source);
    const t = this.localUniforms;
    t.uniforms.uTransformMatrix = e.groupTransform, t.uniforms.uRound = this.renderer._roundPixels | e._roundPixels, t.update(), Y(
      e.groupColorAlpha,
      t.uniforms.uColor,
      0
    ), this._adaptor.execute(this, e);
  ...
  _getMeshData(e) {
    var t, r;
    return (t = e._gpuData)[r = this.renderer.uid] || (t[r] = new we()), e._gpuData[this.renderer.uid].meshData || this._initMeshData(e);
  }
  _initMeshData(e) {
  ...
  _getBatchableMesh(e) {
    var t, r;
    return (t = e._gpuData)[r = this.renderer.uid] || (t[r] = new we()), e._gpuData[this.renderer.uid].batchableMesh || this._initBatchableMesh(e);
  }
...
class Vt {
  execute(e, t) {
    const r = e.state, n = e.renderer, i = t.shader || e.defaultShader;
    i.resources.uTexture = t.texture._source, i.resources.uniforms = e.localUniforms;
    const s = n.gl, a = e.getBuffers(t);
    n.shader.bind(i), n.state.set(r), n.geometry.bind(a.geometry, i.glProgram);
    const u = a.geometry.indexBuffer.data.BYTES_PER_ELEMENT === 2 ? s.UNSIGNED_SHORT : s.UNSIGNED_INT;
    s.drawElements(s.TRIANGLES, t.particleChildren.length * 6, u, 0);
  }
}
class Wt {
  execute(e, t) {
    ...
    const i = e.state, s = e.getBuffers(t);
    r.encoder.draw({
      geometry: s.geometry,
...
class Yt {
  constructor(e) {
    ...
    let n = 0, i = 0;
    for (const h in r) {
      const c = r[h], d = J(c.format);
      c.dynamic ? i += d.stride : n += d.stride;
    }
    this._dynamicStride = i / 4, this._staticStride = n / 4, this.staticAttributeBuffer = new k(t * 4 * n), this.dynamicAttributeBuffer = new k(t * 4 * i), this.indexBuffer = Ce(t);
    const s = new re();
    let a = 0, l = 0;
    this._staticBuffer = new A({
      data: new Float32Array(1),
      label: "static-particle-buffer",
      shrinkToFit: !1,
      usage: C.VERTEX | C.COPY_DST
    }), this._dynamicBuffer = new A({
      data: new Float32Array(1),
  ...
  update(e, t) {
    e.length > this._size && (t = !0, this._size = Math.max(e.length, this._size * 1.5 | 0), this.staticAttributeBuffer = new k(this._size * this._staticStride * 4 * 4), this.dynamicAttributeBuffer = new k(this._size * this._dynamicStride * 4 * 4), this.indexBuffer = Ce(this._size), this.geometry.indexBuffer.setDataWithSize(
      this.indexBuffer,
    ...
    super({
      ...
      resources: {
        ...
        uniforms: {
          ...
          uColor: { value: new De(16777215), type: "vec4<f32>" },
...
class qe {
   ...
   */
  constructor(e, t) {
    this.state = W.for2d(), this.localUniforms = new G({
      uTranslationMatrix: { value: new P(), type: "mat3x3<f32>" },
      uColor: { value: new Float32Array(4), type: "vec4<f32>" },
      uRound: { value: 1, type: "f32" },
      uResolution: { value: [0, 0], type: "vec2<f32>" }
    }), this.renderer = e, this.adaptor = t, this.defaultShader = new $t(), this.state = W.for2d(), this._managedContainers = new B({ renderer: e, type: "renderable", name: "particleContainer" });
  }
  validateRenderable(e) {
    return !1;
  }
  ...
  execute(e) {
    ...
    const i = this.state;
    n.update(t, e._childrenDirty), e._childrenDirty = !1, i.blendMode = ie(e.blendMode, e.texture._source);
    const s = this.localUniforms.uniforms, a = s.uTranslationMatrix;
    e.worldTransform.copyTo(a), a.prepend(r.globalUniforms.globalUniformData.projectionMatrix), s.uResolution = r.globalUniforms.globalUniformData.resolution, s.uRound = r._roundPixels | e._roundPixels, Y(
      e.groupColorAlpha,
      s.uColor,
      0
...
const Ze = class et extends Et {
  ...
  updatePositions() {
    const e = this.positions, {
      ...
      _anchorX: l,
      _anchorY: u
    } = this, h = n + i, c = t > h ? 1 : t / h, d = s + a, f = r > d ? 1 : r / d, m = Math.min(c, f), x = l * t, g = u * r;
    e[0] = e[8] = e[16] = e[24] = -x, e[2] = e[10] = e[18] = e[26] = n * m - x, e[4] = e[12] = e[20] = e[28] = t - i * m - x, e[6] = e[14] = e[22] = e[30] = t - x, e[1] = e[3] = e[5] = e[7] = -g, e[9] = e[11] = e[13] = e[15] = s * m - g, e[17] = e[19] = e[21] = e[23] = r - a * m - g, e[25] = e[27] = e[29] = e[31] = r - g, this.getBuffer("aPosition").update();
  }
...
class tt {
  constructor(e) {
    this._renderer = e, this._managedSprites = new B({ renderer: e, type: "renderable", name: "nineSliceSprite" });
  }
  addRenderable(e, t) {
  ...
  _initGPUSprite(e) {
    const t = e._gpuData[this._renderer.uid] = new Nt(), r = t;
...
class Jt extends se {
  ...
  updateUniforms(e, t, r, n, i, s) {
    const a = this.resources.tilingUniforms, l = s.width, u = s.height, h = s.textureMatrix, c = a.uniforms.uTextureTransform;
    c.set(
      r.a * l / e,
      r.b * l / t,
      r.c * u / e,
...
function tr(o, e, t, r) {
  let n = 0;
  const i = o.length / e, s = r.a, a = r.b, l = r.c, u = r.d, h = r.tx, c = r.ty;
  for (t *= e; n < i; ) {
    const d = o[t], f = o[t + 1];
    o[t] = s * d + l * f + h, o[t + 1] = a * d + u * f + c, t += e, n++;
  }
}
function rr(o, e) {
  const t = o.texture, r = t.frame.width, n = t.frame.height;
  let i = 0, s = 0;
  o.applyAnchorToTexture && (i = o.anchor.x, s = o.anchor.y), e[0] = e[6] = -i, e[2] = e[4] = 1 - i, e[1] = e[3] = -s, e[5] = e[7] = 1 - s;
  const a = P.shared;
  a.copyFrom(o._tileTransform.matrix), a.tx /= o.width, a.ty /= o.height, a.invert(), a.scale(o.width / r, o.height / n), tr(e, 2, 0, a);
}
const O = new Zt();
class nr {
  constructor() {
    this.canBatch = !0, this.geometry = new ae({
      indices: O.indices.slice(),
...
class rt {
  constructor(e) {
    this._state = W.default2d, this._renderer = e, this._managedTilingSprites = new B({ renderer: e, type: "renderable", name: "tilingSprite" });
  }
  validateRenderable(e) {
  ...
  addRenderable(e, t) {
    ...
    this._updateCanBatch(e);
    const n = this._getTilingSpriteData(e), { geometry: i, canBatch: s } = n;
    if (s) {
      n.batchableMesh || (n.batchableMesh = new oe());
      ...
      r.break(t), n.shader || (n.shader = new Jt()), this.updateRenderable(e), t.add(e);
  }
  execute(e) {
    ...
    r.uTransformMatrix = e.groupTransform, r.uRound = this._renderer._roundPixels | e._roundPixels, Y(
      e.groupColorAlpha,
      r.uColor,
      0
    ), this._state.blendMode = ie(e.groupBlendMode, e.texture._source), this._renderer.encoder.draw({
      geometry: O,
      shader: t,
      state: this._state
    });
  ...
  _updateBatchableMesh(e) {
    ...
    n.addressMode !== "repeat" && (n.addressMode = "repeat", n.update()), rr(e, r.uvs), er(e, r.positions);
  }
  destroy() {
  ...
  _updateCanBatch(e) {
    ...
    let n = !0;
    return this._renderer.type === ne.WEBGL && (n = this._renderer.context.supports.nonPowOf2wrapping), t.canBatch = r.textureMatrix.isSimple && (n || r.source.isPowerOfTwo), t.canBatch;
  }
}
rt.extension = {
  type: [
...
class nt {
  constructor(e) {
    this._renderer = e, this._managedBitmapTexts = new B({ renderer: e, type: "renderable", priority: -2, name: "bitmapText" });
  }
  validateRenderable(e) {
  ...
  addRenderable(e, t) {
    ...
    Fe(e, r), e._didTextUpdate && (e._didTextUpdate = !1, this._updateContext(e, r)), this._renderer.renderPipes.graphics.addRenderable(r, t), r.context.customShader && this._updateDistanceField(e);
  }
  updateRenderable(e) {
    const t = this._getGpuBitmapText(e);
    Fe(e, t), this._renderer.renderPipes.graphics.updateRenderable(t), t.context.customShader && this._updateDistanceField(e);
  }
  _updateContext(e, t) {
    const { context: r } = t, n = vt.getFont(e.text, e._style);
    r.clear(), n.distanceField.type !== "none" && (r.customShader || (r.customShader = new ur(this._renderer.limits.maxBatchableTextures)));
    const i = M.graphemeSegmenter(e.text), s = e._style;
    let a = n.baseLineOffset;
    const l = yt(i, s, n, !0), u = s.padding, h = l.scale;
    let c = l.width, d = l.height + l.offsetY;
    s._stroke && (c += s._stroke.width / h, d += s._stroke.width / h), r.translate(-e._anchor._x * c - u, -e._anchor._y * d - u).scale(h, h);
    const f = n.applyFillAsTint ? s._fill.color : 16777215;
    let m = n.fontMetrics.fontSize, x = n.lineHeight;
    s.lineHeight && (m = s.fontSize / h, x = s.lineHeight / h);
    let g = (x - m) / 2;
    g - n.baseLineOffset < 0 && (g = 0);
    for (let _ = 0; _ < l.lines.length; _++) {
      const b = l.lines[_];
      for (let T = 0; T < b.charPositions.length; T++) {
        const z = b.chars[T], F = n.chars[z];
        if (F?.texture) {
          const D = F.texture;
          r.texture(
            D,
  ...
  _updateDistanceField(e) {
    const t = this._getGpuBitmapText(e).context, r = e._style.fontFamily, n = ee.get(`${r}-bitmap`), { a: i, b: s, c: a, d: l } = e.groupTransform, u = Math.sqrt(i * i + s * s), h = Math.sqrt(a * a + l * l), c = (Math.abs(u) + Math.abs(h)) / 2, d = n.baseRenderedFontSize / e._style.fontSize, f = c * n.distanceField.range * (1 / d);
...
function te(o, e) {
  ...
  wt(r, e._anchor, t);
  const i = e._anchor._x * n * 2, s = e._anchor._y * n * 2;
  r.minX -= n - i, r.minY -= n - s, r.maxX -= n - i, r.maxY -= n - s;
}
class it {
  constructor(e) {
    this._renderer = e, e.runners.resolutionChange.add(this), this._managedTexts = new B({
      renderer: e,
      type: "renderable",
  ...
  addRenderable(e, t) {
    ...
    if (e._didTextUpdate) {
      ...
      (r.currentKey !== e.styleKey || e.resolution !== n) && this._updateGpuText(e).catch((i) => {
        console.error(i);
      }), e._didTextUpdate = !1, te(r, e);
    }
  ...
  async _updateGpuText(e) {
    ...
    i && (i.structureDidChange = !0), t.generatingTexture = !1, te(t, e);
  }
  _getGpuText(e) {
    return e._gpuData[this._renderer.uid] || this.initGpuText(e);
  }
  initGpuText(e) {
    const t = new cr();
    return t.renderable = e, t.transform = e.groupTransform, t.texture = R.EMPTY, t.bounds = { minX: 0, maxX: 1, minY: 0, maxY: 0 }, t.roundPixels = this._renderer._roundPixels | e._roundPixels, e._resolution = e._autoResolution ? this._renderer.resolution : e.resolution, e._gpuData[this._renderer.uid] = t, this._managedTexts.add(e), t;
  }
  onTextUnload(e) {
...
function fr(o, e) {
  const t = e.fontFamily, r = [], n = {}, i = /font-family:([^;"\s]+)/g, s = o.match(i);
  function a(l) {
    n[l] || (r.push(l), n[l] = !0);
  }
  if (Array.isArray(t))
...
async function pr(o) {
  ...
  return await new Promise((i, s) => {
    r.onloadend = () => i(r.result), r.onerror = s, r.readAsDataURL(t);
  });
}
...
async function gr(o) {
  const e = o.filter((t) => ee.has(`${t}-and-url`)).map((t) => {
    if (!N.has(t)) {
      const { entries: r } = ee.get(`${t}-and-url`), n = [];
      r.forEach((i) => {
        const s = i.url, l = i.faces.map((u) => ({ weight: u.weight, style: u.style }));
        n.push(
          ...l.map(
            (u) => mr(
              {
...
function xr(o, e, t, r, n) {
  const { domElement: i, styleElement: s, svgRoot: a } = n;
  i.innerHTML = `<style>${e.cssStyle}</style><div style='padding:0;'>${o}</div>`, i.setAttribute("style", `transform: scale(${t});transform-origin: top left; display: inline-block`), s.textContent = r;
...
function _r(o, e) {
  const t = E.getOptimalCanvasAndContext(
    o.width,
    o.height,
    e
  ), { context: r } = t;
...
class at {
  ...
  decreaseReferenceCount(e) {
    ...
    t && (t.usageCount--, t.usageCount === 0 && (t.texture ? this._cleanUp(t.texture) : t.promise.then((r) => {
      ...
      q("HTMLTextSystem: Failed to clean texture");
  ...
  async _buildTexturePromise(e) {
    const { text: t, style: r, resolution: n, textureStyle: i } = e, s = V.get(Xe), a = fr(t, r), l = await gr(a), u = Ot(t, r, l, s), h = Math.ceil(Math.ceil(Math.max(1, u.width) + r.padding * 2) * n), c = Math.ceil(Math.ceil(Math.max(1, u.height) + r.padding * 2) * n), d = s.image, f = 2;
    d.width = (h | 0) + f, d.height = (c | 0) + f;
    const m = xr(t, r, n, l, s);
    await br(d, m, dr() && a.length > 0);
    const x = d;
    let g;
    this._createCanvas && (g = _r(d, n));
    const _ = st(
      g ? g.canvas : x,
      d.width - f,
      d.height - f,
    ...
    return i && (_.source.style = i), this._createCanvas && (this._renderer.texture.initSource(_.source), E.returnCanvasAndContext(g)), V.return(s), _;
  }
...
class ot {
  ...
  addRenderable(e, t) {
    ...
    if (e._didTextUpdate) {
      const n = e._autoResolution ? this._renderer.resolution : e.resolution;
      (r.currentKey !== e.styleKey || e.resolution !== n) && this._updateGpuText(e), e._didTextUpdate = !1, te(r, e);
    }
    this._renderer.renderPipes.batch.addToBatch(r, t);
  }
  updateRenderable(e) {
...
class ut {
  ...
  getTexture(e, t, r, n) {
    typeof e == "string" && (I("8.0.0", "CanvasTextSystem.getTexture: Use object TextOptions instead of separate arguments"), e = {
      ...
      style: r,
      resolution: t
    }), e.style instanceof pe || (e.style = new pe(e.style)), e.textureStyle instanceof Z || (e.textureStyle = new Z(e.textureStyle)), typeof e.text != "string" && (e.text = e.text.toString());
    const { text: i, style: s, textureStyle: a } = e, l = e.resolution ?? this._renderer.resolution, { frame: u, canvasAndContext: h } = H.getCanvasAndContext({
      text: i,
      style: s,
      resolution: l
    }), c = st(h.canvas, u.width, u.height, l);
    if (a && (c.source.style = a), s.trim && (u.pad(s.padding), c.frame.copyFrom(u), c.frame.scale(1 / l), c.updateUvs()), s.filters) {
      const d = this._applyFilters(c, s.filters);
      return this.returnTexture(c), H.returnCanvasAndContext(h), d;
    }
    return this._renderer.texture.initSource(c._source), H.returnCanvasAndContext(h), c;
  }
  /**
...
y.add(Le);
y.add(We);
//# sourceMappingURL=init-CkiK71bj.js.map
