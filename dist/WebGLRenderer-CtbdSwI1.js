...
class ee {
   ...
   */
  constructor(e) {
    this._boundBufferBases = /* @__PURE__ */ Object.create(null), this._minBaseLocation = 0, this._nextBindBaseIndex = this._minBaseLocation, this._bindCallId = 0, this._renderer = e, this._managedBuffers = new G({
      renderer: e,
      type: "resource",
...
class se {
  /** @param renderer - The renderer this System works for. */
  constructor(e) {
    this._renderer = e, this._activeGeometry = null, this._activeVao = null, this.hasVao = !0, this.hasInstance = !0, this._managedGeometries = new G({
      renderer: e,
      type: "resource",
  ...
  initGeometryVao(e, r, s = !0) {
    ...
    const a = this.getSignature(e, r), o = new Ke();
    ...
    return this.activateVao(e, r), c[r._key] = u, c[a] = u, n.bindVertexArray(null), u;
  }
  ...
  activateVao(e, r) {
    ...
    for (const o in i) {
      ...
      if (h) {
        ...
        const E = K(c.format), L = We(c.format);
...
class Je {
  ...
  startRenderPass(e, r = !0, s, n) {
    ...
    let c = n.y;
    e.isRoot && (c = a.pixelHeight - n.height - n.y), e.colorTextures.forEach((h) => {
      this._renderer.texture.unbind(h);
    });
    const u = this._renderer.gl;
    u.bindFramebuffer(u.FRAMEBUFFER, o.framebuffer), e.colorTextures.length > 1 && this._setDrawBuffers(e, u);
  ...
  initGpuRenderTarget(e) {
    const s = this._renderer.gl, n = new Ye();
  ...
  _initColor(e, r) {
    ...
    if (r.resolveTargetFramebuffer = i, n.bindFramebuffer(n.FRAMEBUFFER, i), r.width = e.colorTexture.source.pixelWidth, r.height = e.colorTexture.source.pixelHeight, e.colorTextures.forEach((o, c) => {
      const u = o.source;
      u.antialias && (s.context.supports.msaa ? r.msaa = !0 : m("[RenderTexture] Antialiasing on textures is not supported in WebGL1")), s.texture.bindSource(u, 0);
      const h = s.texture.getGlSource(u).texture;
      ...
      r.framebuffer = o, n.bindFramebuffer(n.FRAMEBUFFER, o), e.colorTextures.forEach((c, u) => {
...
function ct(t, e) {
  const r = k(t, t.VERTEX_SHADER, e.vertex), s = k(t, t.FRAGMENT_SHADER, e.fragment), n = t.createProgram();
  ...
  )), t.linkProgram(n), t.getProgramParameter(n, t.LINK_STATUS) || ot(t, n, r, s), e._attributeData = nt(
    n,
    t,
    !/^[ \t]*#[ \t]*version[ \t]+300[ \t]+es[ \t]*$/m.test(e.vertex)
  ), e._uniformData = at(n, t), e._uniformBlockData = it(n, t), t.deleteShader(r), t.deleteShader(s);
  const a = {};
...
class de {
  ...
  _createProgramData(e) {
    const r = e._key;
    return this._programDataHash[r] = ct(this._gl, e), this._programDataHash[r];
  }
  destroy() {
...
function ft(t, e) {
  ...
  for (const s in t.uniforms) {
    ...
    if (!i) {
      const o = (n.size === 1 ? ut : _t)[n.type].replace("location", `ud["${s}"].location`);
      r.push(`
            cu = ud["${s}"];
            cv = cu.value;
            v = uv["${s}"];
...
const lt = 0, dt = 1, mt = 2, Et = 3, bt = 4, St = 5, Ee = class I {
  constructor(e) {
    this._invertFrontFace = !1, this.gl = null, this.stateId = 0, this.polygonOffset = 0, this.blendMode = "none", this._blendEq = !1, this.map = [], this.map[lt] = this.setBlend, this.map[dt] = this.setOffset, this.map[mt] = this.setCullFace, this.map[Et] = this.setDepthTest, this.map[bt] = this.setFrontFace, this.map[St] = this.setDepthMask, this.checks = [], this.defaultState = O.for2d(), e.renderTarget.onRenderTargetChange.add(this);
  }
  onRenderTargetChange(e) {
...
function j(t, e, r, s, n, i, a, o) {
  ...
  if ((!o || t.magFilter !== "linear") && e[n](c, e.TEXTURE_MAG_FILTER, W[t.magFilter]), r) {
    if (!o || t.mipmapFilter !== "linear") {
      const u = Bt[t.minFilter][t.mipmapFilter];
...
class Se {
  constructor(e) {
    this._glSamplers = /* @__PURE__ */ Object.create(null), this._boundTextures = [], this._activeTextureLocation = -1, this._boundSamplers = /* @__PURE__ */ Object.create(null), this._uploads = {
      ...
      video: Tt,
      compressed: vt
    }, this._premultiplyAlpha = !1, this._useSeparateSamplers = !1, this._renderer = e, this._managedTextures = new G({
      renderer: e,
      type: "resource",
  ...
  contextChange(e) {
    this._gl = e, this._mapFormatToInternalFormat || (this._mapFormatToInternalFormat = yt(e, this._renderer.context.extensions), this._mapFormatToType = Ct(e), this._mapFormatToFormat = Nt(e)), this._managedTextures.removeAll(!0), this._glSamplers = /* @__PURE__ */ Object.create(null), this._boundSamplers = /* @__PURE__ */ Object.create(null), this._premultiplyAlpha = !1;
    for (let r = 0; r < 16; r++)
      this.bind(b.EMPTY, r);
  }
  /**
  ...
  _initSource(e) {
    const r = this._gl, s = new gt(r.createTexture());
