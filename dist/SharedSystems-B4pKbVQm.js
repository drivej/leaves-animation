...
class nt extends Ze {
  constructor(e) {
    const { sprite: t, ...r } = e, s = new Fe(t.texture), n = new oe({
...
class xe {
  ...
  execute(e) {
    ...
    e.action === "pushMaskBegin" ? (r.renderTarget.ensureDepthStencil(), r.stencil.setStencilMode(f.RENDERING_MASK_ADD, n), n++, r.colorMask.setMask(0)) : e.action === "pushMaskEnd" ? (e.inverse ? r.stencil.setStencilMode(f.INVERSE_MASK_ACTIVE, n) : r.stencil.setStencilMode(f.MASK_ACTIVE, n), r.colorMask.setMask(15)) : e.action === "popMaskBegin" ? (r.colorMask.setMask(0), n !== 0 ? r.stencil.setStencilMode(f.RENDERING_MASK_REMOVE, n) : (r.renderTarget.clear(null, G.STENCIL), r.stencil.setStencilMode(f.DISABLED, n)), n--) : e.action === "popMaskEnd" && (e.inverse ? r.stencil.setStencilMode(f.INVERSE_MASK_ACTIVE, n) : r.stencil.setStencilMode(f.MASK_ACTIVE, n), r.colorMask.setMask(15)), this._maskStackHash[s] = n;
  }
  destroy() {
...
function Se(a, e, t) {
  ...
  ), t & ne && ae(a, s, t)) : (t = a._updateFlags, a.relativeGroupTransform.copyFrom(r), t & ne && ae(a, ht, t)), !a.renderGroup) {
...
function ae(a, e, t) {
  ...
  t & fe && (a.groupBlendMode = a.localBlendMode === "inherit" ? e.groupBlendMode : a.localBlendMode), t & ce && (a.globalDisplayStatus = a.localDisplayStatus & e.globalDisplayStatus), a._updateFlags = 0;
}
function pt(a, e) {
  ...
  _updateCachedRenderGroups(e, t) {
    ...
    if (e.invalidateMatrices(), e.isCachedAsTexture) {
      if (e.textureNeedsUpdate) {
        ...
        const n = this._renderer, i = e.textureOptions.resolution || n.view.resolution, o = e.textureOptions.antialias ?? n.view.antialias, l = e.textureOptions.scaleMode ?? "linear", d = y.getOptimalTexture(
          r.width,
          r.height,
          i,
          o
...
const B = {
  ...
  async base64(e) {
    ...
    if (s.convertToBlob !== void 0) {
      const n = await s.convertToBlob({ type: B[t], quality: r });
  ...
  pixels(e) {
    ...
    return t instanceof U && s.destroy(!0), n;
  }
  /**
...
class Ge {
  ...
  generateTexture(e) {
    ...
    let n = e.clearColor;
    n ? n = Array.isArray(n) && n.length === 4 ? n : I.shared.setValue(n).toArray() : n = bt;
    const i = e.frame?.copyTo(vt) || Ke(s, xt).rectangle;
...
const $ = class Ae {
  ...
  runOnHash(e, t) {
    ...
    for (const d in i) {
      ...
      n === "renderable" && this.updateRenderableGCTick(c, t), !(t - c._gcLastUsed < this.maxUnusedTime) && c.autoGarbageCollect ? (o || (l + 1 !== 1e4 ? (i[d] = null, l++) : o = this._createHashClone(i, d)), c.unload(), c._gcData = null, c._gcLastUsed = -1) : o && (o[d] = c);
    }
    o && (r[s] = o);
  }
...
//# sourceMappingURL=SharedSystems-B4pKbVQm.js.map
